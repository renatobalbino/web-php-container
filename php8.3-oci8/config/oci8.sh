...
/usr/bin/pecl83 channel-update pecl.php.net
sh -c "echo 'instantclient,/opt/oracle/instantclient' | /usr/bin/pecl83 install oci8"

#enable extension
echo 'extension=oci8' > /etc/php83/conf.d/03_oci8.ini
